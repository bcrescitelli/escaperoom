    ...
    <svg className="assetSvg" viewBox="0 0 380 200" aria-hidden="true">
      ...
      {[['SALT', '7', 68], ['SUGAR', '3', 148], ['CHERRY', '5', 232], ['OLIVE', '2', 312]].map(([label, number, x]) => (
        <g key={label}>
          ...
          <text className="jarNumberText" x={x} y="118" textAnchor="middle">{number}</text>
        </g>
      ))}
    </svg>
  );
...
function MirrorWallSvg() {
  return (
    <svg className="assetSvg" viewBox="0 0 240 290" aria-hidden="true">
      ...
      <path className="mirrorScript" d="M88 118h64M92 146h58" />
    </svg>
  );
}
...
function StickySvg() {
  return (
    <svg className="assetSvg" viewBox="0 0 180 160" aria-hidden="true">
      ...
      <path className="noteLine" d="M56 52h70M56 74h52M56 96h74" />
...
function ArcadeSvg() {
  return (
    <svg className="assetSvg" viewBox="0 0 260 350" aria-hidden="true">
      ...
      <text className="arcadeScreenText" x="130" y="96" textAnchor="middle">9 2 1 6</text>
...
function RibbonSvg() {
  return (
    <svg className="assetSvg" viewBox="0 0 190 120" aria-hidden="true">
      ...
      <text className="ribbonText" x="76" y="62" textAnchor="middle">B = 2</text>
    </svg>
  );
}
