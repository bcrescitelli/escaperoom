    ...
    <main className="gameShell">
      ...
      <section className="centerStage">
        ...
        <div className="sceneMetaBar">
          ...
          <button
            className={`modeButton ${blacklightOn ? 'active' : ''}`}
            onClick={() => setBlacklightOn((value) => !value)}
          >
            {blacklightOn ? 'Blacklight on' : 'Use blacklight'}
          </button>
        </div>

        <div className={`roomStage ${activeRoom.palette} ${blacklightOn ? 'blacklightOn' : ''}`} ref={stageRef} onMouseMove={handleMouseMove}>
          <RoomArt room={activeRoom} game={game} openHotspot={setSelectedHotspot} blacklightOn={blacklightOn} />
...
function RoomArt({ room, game, openHotspot, blacklightOn }) {
  return (
