  ...
  return (
    <main className="joinShell">
      ...
      <section className="joinCard">
        ...
        <h1>A live collaborative escape room for one suspicious little friend group.</h1>
        <p>
          Enter a shared room code, jump on FaceTime, and search the same strange apartment together. You’ll see each other’s cursors, shared inventory, unlocks, and solves in real time.
        </p>
        <div className="joinForm">
          ...
          <button className="primaryButton" onClick={join}>
            Enter the Curio <ChevronRight size={18} />
          </button>
        </div>
        <div className="joinNotes">
          <span>Best on laptop</span>
          <span>30 minute target</span>
          <span>4 to 5 players</span>
        </div>
      </section>
    </main>
  );
